...
r_sch.bold = True
r_m = p_edu.add_run("Master of Science in Computer and Information Sciences - AI and Cybersecurity  (Sept 2025 – July 2027 Expected)\n")
r_m.bold = True
r_b = p_edu.add_run("Bachelor of Science in Computer Science  (Sept 2022 – June 2025 Completed)")
add_bullet(doc, "Academic Distinction: ", "Ranked 3rd out of cohort across L1 and L2 semesters. Core Coursework: C Programming, Data Structures, Algorithms, Computer Architecture, Operating Systems.")

# PROJECTS
add_section_title(doc, "AI and Software Engineering Projects")
...
# LEADERSHIP
add_section_title(doc, "Leadership and Global Programs")
...
add_bullet(doc, "Algerian-American Summer University 2025: ", "Advanced Computing Track (AI, Machine Learning, Cybersecurity and Ethics)")
