% =====================================================================
% ATS-OPTIMIZED RESUME TEMPLATE -- CUSTOMIZED FOR SPARK AI RESEARCH
...
\begin{center}
  ...
  {\large SPARK AI Research Fellow (Remote) | Master's Student in Artificial Intelligence \& Cybersecurity}\\[4pt]
...
% =====================================================================
\section{SKILLS}
\noindent\textbf{AI \& Research:} Artificial Intelligence, Machine Learning (Random Forest, SVM RBF, Deep Learning), Natural Language Processing (NLP), LLM Integration, AI Ethics, Data Ethics, Scientific Analysis, Research Methodology, Literature Review, Prototyping\par
\noindent\textbf{Programming \& Web:} Python (NumPy, Pandas, Scikit-learn, Matplotlib), C, HTML5, CSS, JavaScript, TypeScript, Flutter/Dart, SQL (PostgreSQL), Git/GitHub\par
